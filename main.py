#Ce code implémente un modèle de réseau de neurones simple pour apprendre la logique XOR en utilisant une architecture de type perceptron multicouches. 
from tkinter import *
import numpy as np
import math
import random
...
class Gui:
    ...
    # Fonction pour le backpropagation
